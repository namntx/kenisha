...
<div>
    <div class="flex items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Thêm khách hàng mới</h1>
    </div>
        ...
        <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        <div class="flex items-center">
                            <input id="is_sync_enabled" name="is_sync_enabled" type="checkbox" {{ old('is_sync_enabled') ? 'checked' : '' }}
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        <div class="flex items-center">
                            <input id="south_straight_bonus" name="south_straight_bonus" type="checkbox" {{ old('south_straight_bonus') ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center">
                                <input type="radio" id="south_straight_win_type_1" name="south_straight_win_type" value="1" 
                                    {{ old('south_straight_win_type', 2) == 1 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="south_straight_win_type_2" name="south_straight_win_type" value="2" 
                                    {{ old('south_straight_win_type', 2) == 2 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="south_straight_win_type_3" name="south_straight_win_type" value="3" 
                                    {{ old('south_straight_win_type', 2) == 3 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center">
                                <input type="radio" id="south_slide_win_type_1" name="south_slide_win_type" value="1" 
                                    {{ old('south_slide_win_type', 3) == 1 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="south_slide_win_type_2" name="south_slide_win_type" value="2" 
                                    {{ old('south_slide_win_type', 3) == 2 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="south_slide_win_type_3" name="south_slide_win_type" value="3" 
                                    {{ old('south_slide_win_type', 3) == 3 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        <div class="flex items-center">
                            <input id="north_straight_bonus" name="north_straight_bonus" type="checkbox" {{ old('north_straight_bonus') ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center">
                                <input type="radio" id="north_slide_win_type_1" name="north_slide_win_type" value="1" 
                                    {{ old('north_slide_win_type', 2) == 1 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="north_slide_win_type_2" name="north_slide_win_type" value="2" 
                                    {{ old('north_slide_win_type', 2) == 2 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="north_slide_win_type_3" name="north_slide_win_type" value="3" 
                                    {{ old('north_slide_win_type', 2) == 3 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        <div class="flex items-center">
                            <input id="central_straight_bonus" name="central_straight_bonus" type="checkbox" {{ old('central_straight_bonus') ? 'checked' : '' }}
                                class="h-4 w-4 text-blue-600 border-gray-300 rounded">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center">
                                <input type="radio" id="central_straight_win_type_1" name="central_straight_win_type" value="1" 
                                    {{ old('central_straight_win_type', 2) == 1 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="central_straight_win_type_2" name="central_straight_win_type" value="2" 
                                    {{ old('central_straight_win_type', 2) == 2 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="central_straight_win_type_3" name="central_straight_win_type" value="3" 
                                    {{ old('central_straight_win_type', 2) == 3 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center">
                                <input type="radio" id="central_slide_win_type_1" name="central_slide_win_type" value="1" 
                                    {{ old('central_slide_win_type', 3) == 1 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="central_slide_win_type_2" name="central_slide_win_type" value="2" 
                                    {{ old('central_slide_win_type', 3) == 2 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="central_slide_win_type_3" name="central_slide_win_type" value="3" 
                                    {{ old('central_slide_win_type', 3) == 3 ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300">
            ...
            <div class="p-6 flex justify-end">
                <a href="{{ route('customers.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mr-3">
                    Hủy
                </a>
