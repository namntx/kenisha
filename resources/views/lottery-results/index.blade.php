                ...
                <div class="mt-5 sm:mt-6">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <select id="fetch_region" name="fetch_region" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-2 py-2 border">
                        ...
                        <div id="provinceSelector" class="hidden">
                            ...
                            <select id="fetch_province" name="fetch_province" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-2 py-2 border">
